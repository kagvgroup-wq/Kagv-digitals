...
// Cart icon toggle
cartCountElem.addEventListener("click", ()=>{ cartPopup.style.display = cartPopup.style.display==="block"?"none":"block"; });
...
// Save Cart
function saveCart(){ localStorage.setItem("kagvCart", JSON.stringify(cart)); }
...
const loginBtns = document.querySelectorAll(".login-btn-submit");

// Open/Close
loginBtn.addEventListener("click", ()=>{ loginPopup.style.display="block"; });
